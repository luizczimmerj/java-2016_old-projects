 ...
 * @author Luiz
 */
public class telaVetorExercicio extends javax.swing.JFrame {

    int vetor [ ] = new int [10];
    DefaultListModel lista = new DefaultListModel();
    int selecionado = 0;
    /**
     * Creates new form telaVetorExercicio
     */
    public telaVetorExercicio() {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblSelecionado.setForeground(new java.awt.Color(51, 51, 255));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(telaVetorExercicio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new telaVetorExercicio().setVisible(true);
            }
        });
    }
