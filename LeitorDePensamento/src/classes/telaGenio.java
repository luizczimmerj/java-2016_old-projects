...
public class telaGenio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(lblFrase, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 70, 140, 60));
        ...
        getContentPane().add(txtVal, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 240, 70, -1));
        ...
        getContentPane().add(btnPalpite, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 290, 90, 30));
    ...
    private void btnPalpiteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPalpiteActionPerformed
        ...
        double n = 1 + Math.random() * (6 - 1) ; // Cria um número aleatório.
        int valor = (int) n;
        
        int num = Integer.parseInt(txtVal.getValue().toString()); // Pega o numero do usuário.
        
        String f1 = "<html>Acertou !</html>" ;
        String f2 = "<html>Errou. Eu pensei no  " + valor + "</html>";
        
        String res = (valor == num)? f1:f2; // Compara os valores.
